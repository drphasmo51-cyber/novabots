...
function showCheckoutSuccess() {
  ...
  box.innerHTML = `
    ...
    <div class="checkout-success">
      ...
      <p style="opacity:.8; margin: 10px 0 20px;">We'll open a ticket here for you, to discuss how you'd like the bot built.</p>

      <form id="ticketForm" style="display:flex; flex-direction:column; gap:12px; text-align:left;">
        <div>
        ...
        <button type="submit" class="primary" style="margin-top:15px; cursor:pointer; width:100%;">Open My Ticket</button>
      </form>
    </div>
  `;
  ...
  document.getElementById("ticketForm").addEventListener("submit", function(e) {
    ...
    submitBtn.textContent = "Opening ticket...";
    ...
    db.collection("tickets").add({
      ...
      box.innerHTML = `
        <div class="checkout-success">
          <span class="icon">🎫</span>
          <h3>Ticket Opened!</h3>
          <p style="opacity:.75;margin-top:10px">We've opened a ticket for your order. Join our Discord server and we'll reach out shortly to discuss your bot.</p>
      ...
      submitBtn.textContent = "Open My Ticket";
      alert("Failed to open ticket. Please join our Discord server and let us know!");
